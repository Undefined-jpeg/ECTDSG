...
import com.ectdsg.projectiles.FireProjectile;
import java.awt.*;
...
public class FireTower extends Tower {
    ...
    public FireTower(int x, int y, TowerDefence game) {
        super(x, y, game);
        this.damage = 10;
        this.fireRate = 1000;
        this.range = RANGE;
        this.color = Color.RED;
        this.attackColor = Color.ORANGE;
        this.cost = COST;
    }
    ...
    public void attack() {
        ...
        if (currentTarget != null) {
            game.projectiles.add(new FireProjectile(x, y, damage, currentTarget, attackColor, FIRE_DAMAGE, FIRE_DURATION));
