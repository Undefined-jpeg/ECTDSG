...
public class ControlPanel extends JPanel {
    ...
    private final JButton buildReactorCoreButton;
    ...
    public ControlPanel(TowerDefence game, int height) {
        ...
        buildReactorCoreButton = new JButton("REACTOR ($" + ReactorCoreTower.COST + ")");
        buildReactorCoreButton.addActionListener(e -> { if (game.playerMoney >= ReactorCoreTower.COST) { game.placingTowerType = TowerDefence.REACTOR; toggleBuildButtons(false); } });
        ...
        buildPanel.add(buildReactorCoreButton);
    ...
    private void toggleBuildButtons(boolean enableBuild) {
        ...
        buildReactorCoreButton.setEnabled(enableBuild);
