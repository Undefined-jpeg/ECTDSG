...
public class PriestEnemy extends Enemy {

    private long lastHealTime = 0;
    private final long HEAL_COOLDOWN = 2000; // 2 seconds
    private final int HEAL_RADIUS = 50;
    private final int HEAL_AMOUNT = 25;

    public PriestEnemy(Path path, int health, double speed) {
        super(path, health, speed, 35, "PRIEST_ENEMY");
        this.color = new Color(255, 255, 0); // Green
    }
